...
const NavBar_Web_dev = () => {
  return (
    <div className="min-h-screen bg-black background bg-right bg-no-repeat  text-white" style={{backgroundImage:`url(${assets.Rectangle_37})`}}>
